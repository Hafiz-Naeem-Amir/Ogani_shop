...
<head>
    ...
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
       <!-- Favicon -->
    <link rel="icon" type="image/png"  sizes="64x64" href="{{ asset('ogani-master\img\favicon.png') }}">
    ...
    <link rel="stylesheet"
    href="{{ asset('ogani-master/css/elegant-icons.css') }}" type="text/css">
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="header__logo">
                        <a href="/home"><img src="{{ asset('ogani-master/img/logo.png') }}" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-6">
                    <nav class="header__menu">
                        <ul>
                            ...
                            <li><a href="{{ url('site/shop') }}">Shop</a></li>
                            <li><a href="#">Pages</a>
                                <ul class="header__menu__dropdown">
                                    <li><a href="{{ url('site/shop_details') }}">Shop Details</a></li>
                                    <li><a href="{{ url('site/shop_cart') }}">Shoping Cart  </a></li>
                                    <li><a href="{{ url('site/shop_checkout') }}">Check Out</a></li>
                                    <li><a href="{{ url('site/blog_details') }}">Blog Details</a></li>
                                </ul>
                            </li>
