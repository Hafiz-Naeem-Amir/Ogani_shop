...
$('#saveProduct').on('click', function () {
    ...
    let url = productId ? "/admin/product/update" : "{{ route('admin.product.store') }}";
...
$(document).on('click', '.editBtn', function() {
 ...
 $(document).on('click', '.removeImage', function() {
    ...
    $.ajax({
        ...
        type: 'POST',
        data: { product_id: $('#product_id').val(), image: imgName, _token: '{{ csrf_token() }}' },
