          ...
          <div class="row g-3">
            <div class="col-md-3">
               ...
               <select class="form-control" id="page_id" name="page_id">
                   ...
                   <?php $__currentLoopData = $pag; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                       <option value="<?php echo e($page->id); ?>"><?php echo e($page->p_type_name); ?></option>
...
<script>
    ...
    var table = $('#dataTable').DataTable({
        ...
        serverSide: true,
        responsive: true,
        ajax: "<?php echo e(url('admin/contents-data')); ?>",
        columns: [
            {data:'id', name:'id'},
   ...
   $('#saveContent').off('click').on('click', function(e){
    ...
    let url = id ? `/admin/contents/${id}` : "<?php echo e(url('admin/contents-store')); ?>";
    ...
    $(document).on('click', '.deleteBtn', function(){
        ...
        Swal.fire({
            ...
            if(result.isConfirmed){
                $.ajax({
                    url: `<?php echo e(url('admin/content')); ?>/` + id,
                    type: 'DELETE',
...
<?php echo $__env->make('admin.layout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laravel Internship projects\ogani-shop\resources\views/admin/pages/content.blade.php ENDPATH**/ ?>