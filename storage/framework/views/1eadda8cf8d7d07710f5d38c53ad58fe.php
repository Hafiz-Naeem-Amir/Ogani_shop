...
$(function () {
   var table = $('#dataTable').DataTable({
    ...
    serverSide: true,
    responsive: true,
    ajax: "<?php echo e(url('admin/-vareint-table')); ?>",
    columns: [
        { data: 'id', name: 'id' },
        { data: 'name', name: 'name' },
        {
...
// remove
    ...
    $("#productForm").submit(function(e){
        ...
        $.ajax({
            url: "<?php echo e(route('admin.verient.store')); ?>",
            type: "POST",
            data: formData,
...
//  update
 ...
 // Submit form via AJAX
    $("#productForm").submit(function(e){
        ...
        $.ajax({
            url: "<?php echo e(route('admin.verient.update')); ?>",
            type: "POST",
            data: formData,
            success: function(response){
                Swal.fire({
...
<?php echo $__env->make('admin.layout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laravel Internship projects\ogani-shop\resources\views/admin/verient/index.blade.php ENDPATH**/ ?>