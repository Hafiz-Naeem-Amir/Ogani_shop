...
$(function () {
    var table = $('#dataTable').DataTable({
        processing: true,
        serverSide: true,
        ajax: "<?php echo e(url('admin/pages-data')); ?>",
        columns: [
            { data: 'id', name: 'id' },
...
<?php echo $__env->make('admin.layout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laravel Internship projects\ogani-shop\resources\views/admin/pages/create.blade.php ENDPATH**/ ?>